const main = () => {
    const connectedComponentCountUF = (n, edges) => {
        const parents = []
        ...
        let componentCount = n //we starting with n components and subtracting per union
        for (let edge of edges) {
            const [n1, n2] = edge
            componentCount -= union(n1, n2)
        }
        return componentCount
    }
    console.log(connectedComponentCountUF(5, [[0, 1], [1,2], [3,4]]))
}
main()
